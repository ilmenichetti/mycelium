...
text(mlv(d_pi1$x, method = "Parzen"),max(d_pi1$y)*1.01, pi_names[1], col=parms_palette[1], cex=0.8) #add a text on top of the distribution
...
text(mlv(d_pi2$x, method = "Parzen"), max(d_pi2$y)*1.01, pi_names[2], col=parms_palette[2], cex=0.8) #add a text on top of the distribution
...
text(mlv(d_pi3$x, method = "Parzen")*0.8, max(d_pi3$y)*1.01, pi_names[3], col=parms_palette[3], cex=0.8) #add a text on top of the distribution
...
text(mlv(d_pi4$x, method = "Parzen")*0.8, max(d_pi4$y)*1.01, pi_names[4], col=parms_palette[4], cex=0.8) #add a text on top of the distribution
legend("topright","(a)", bty="n")
